...
**Labels:** ensure `ai-generated` and `ready-for-review` exist; create if missing:

```bash
gh label list --search "ai-generated" > /dev/null 2>&1 || \
  gh label create "ai-generated" --description "PR generated by an AI agent" --color "5319E7"
gh label list --search "ready-for-review" > /dev/null 2>&1 || \
  gh label create "ready-for-review" --description "PR is ready for human review" --color "0E8A16"
```
